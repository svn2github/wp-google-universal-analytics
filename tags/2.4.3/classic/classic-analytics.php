<div class="wrap">
  ...
  <div class="col-lg-6 row">
    ...
    <?php settings_fields('google-universal-settings-classic'); ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <input type="text" class="form-control" name="classic_property_id" id="classic_property_id" placeholder="Property ID example: UA-­23710779-­7" value="<?php echo get_option('classic_property_id'); ?>">
     ...
     $roles = $wp_roles->get_names(); ?>
          <div class="checkbox">
            <label>
              ...
              <select id="classic_tracking_off_for_this_role" name="classic_tracking_off_for_this_role">
  ...
  <div class="row col-lg-6"><?php echo __('Have a question? Drop it at', 'gua'); ?> <a href="http://onlineads.lt/?utm_source=WordPress&utm_medium=Google%20Universal%20Analytics%202.4.3&utm_content=Google%20Classic%20Analytics&utm_campaign=WordPress%20plugins" title="Google Universal Analytics">OnlineAds.lt</a> </div>      </br></br>  <strong>Pro Tip:</strong> For periodic Google Analytics data reporting use <a href="https://nexusad.com/?utm_source=wordpress&utm_medium=Google%2BUniversal%2BAnalytics%2B2.4.3&utm_campaign=wp_plugins" title="nexusAd" target="_blank">nexusAd tool</a>.    
</div>
</br>
